...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $post_data = array();
        $post_data['total_amount'] = round(session()->get('s_total') + session('s_shipping')); # You cant not pay less than 10
        ...
        $post_data['cus_add1'] = getGeoName($request->city) . ',' . getGeoName($request->district) . ',' . getGeoName($request->thana);
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        $post_data['cus_state'] = "";
        $post_data['cus_postcode'] = $request->billing_postcode;
        $post_data['cus_country'] = "Bangladesh";
        $post_data['cus_phone'] = $request->billing_phone_number;
        $post_data['cus_fax'] = "";
        ...
        $post_data['value_d'] = ($request->country == 'BD') ?  120 : 500;
    ...
    public function success(Request $request)
    {
        ...
        if ($transaction) {
            ...
            foreach ($keys as $key => $val) {
                ...
                if ($val == 'country') {
                    $billing_info[$val] = Geo::Country($values[$key])->level(Geo::LEVEL_COUNTRY)->orderBy('population', 'DESC')->first()->name;
                    continue;
                }
