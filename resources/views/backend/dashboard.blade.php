                            ...
                            <div class="tab-content p-0">
                                ...
                                <div class="chart tab-pane active" id="revenue-chart"
                                    ...
                                    <canvas id="revenue-chart-canvas" height="300"
                                        style="height: 300px; display: block; width: 576px;" width="576"
                    ...
                    <div class="card bg-gradient-primary">
                        ...
                        <div class="card-body">
                            <div id="world-map"
                                ...
                                <svg width="493.734" height="250">
                                    <g transform="scale(0.42158516020236086) translate(106.06852400000001, 0)">
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke="#818181" stroke-width="1" stroke-linecap="round"
                                            stroke-linejoin="round" stroke-opacity="0.25" fill="#f4f3f0"
                                            original="#f4f3f0" id="jqvmap1_wa" class="jqvmap-region" fill-opacity="1">
                                        </path>
                                        <path
                    ...
                    <div class="card bg-gradient-info">
                        ...
                        <div class="card-body">
                            ...
                            <canvas class="chart chartjs-render-monitor" id="line-chart"
                                style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%; display: block; width: 395px;"
                                width="395" height="250"></canvas>
                        </div>
                        <!-- /.card-body -->
                        <div class="card-footer bg-transparent">
                            <div class="row">
                                                ...
                                                <div class="datepicker-days" style="">
                                                    <table class="table table-sm">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="picker-switch" data-action="pickerSwitch"
                                                                    colspan="5" title="Select Month">June 2021</th>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td data-action="selectDay" data-day="06/06/2021"
                                                                    class="day weekend">6</td>
                                                                <td data-action="selectDay" data-day="06/07/2021"
                                                                    class="day">7</td>
                                                                <td data-action="selectDay" data-day="06/08/2021"
                                                                    class="day">8</td>
                                                                <td data-action="selectDay" data-day="06/09/2021"
                                                                    class="day">9</td>
                                                                <td data-action="selectDay" data-day="06/10/2021"
                                                                    class="day">10</td>
                                                                <td data-action="selectDay" data-day="06/11/2021"
                                                                    class="day">11</td>
                                                                <td data-action="selectDay" data-day="06/12/2021"
                                                                    class="day weekend">12</td>
                                                            </tr>
                                                            <tr>
                                                                <td data-action="selectDay" data-day="06/13/2021"
                                                                    class="day weekend">13</td>
                                                                <td data-action="selectDay" data-day="06/14/2021"
                                                                    class="day">14</td>
                                                                <td data-action="selectDay" data-day="06/15/2021"
                                                                    class="day">15</td>
                                                                <td data-action="selectDay" data-day="06/16/2021"
                                                                    class="day">16</td>
                                                                <td data-action="selectDay" data-day="06/17/2021"
                                                                    class="day">17</td>
                                                                <td data-action="selectDay" data-day="06/18/2021"
                                                                    class="day active today">18</td>
                                                                <td data-action="selectDay" data-day="06/19/2021"
                                                                    class="day weekend">19</td>
                                                            </tr>
                                                            <tr>
                                                                <td data-action="selectDay" data-day="06/20/2021"
                                                                    class="day weekend">20</td>
                                                                <td data-action="selectDay" data-day="06/21/2021"
                                                                    class="day">21</td>
                                                                <td data-action="selectDay" data-day="06/22/2021"
                                                                    class="day">22</td>
                                                                <td data-action="selectDay" data-day="06/23/2021"
                                                                    class="day">23</td>
                                                                <td data-action="selectDay" data-day="06/24/2021"
                                                                    class="day">24</td>
                                                                <td data-action="selectDay" data-day="06/25/2021"
                                                                    class="day">25</td>
                                                                <td data-action="selectDay" data-day="06/26/2021"
