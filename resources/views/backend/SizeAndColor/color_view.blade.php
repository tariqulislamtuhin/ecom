                ...
                <form method="POST" action="{{ route('PostColor') }}">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('color_name') is-invalid @enderror" id="color_name" placeholder="Color name" name="color_name">
                    </div>
                    @error('color_name')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" placeholder="Color Slug"name="slug">
                    </div>
                    @error('slug')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
